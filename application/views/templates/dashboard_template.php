...
<html>
	...
	<title>PLN Bogor, Jawa Barat &mdash; Melayani dengan sepenuh hati </title>
	...
	<body class="hold-transition skin-green sidebar-mini">
		...
		<header class="main-header">
		  ...
		  <a href=" <?php echo base_url('dashboard'); ?>" class="logo">
		    ...
		    <span class="logo-lg"><b>PLN</b> Bogor</span>
		  </a>
		          ...
		          <ul class="dropdown-menu">
		            ...
		            <li class="user-header">
		              ...
		              <p>
		                <?php echo $nama.' - '.$role_name;  ?>
										<br/>
		                <small><?php echo $role_name.' Sejak '.date("d F Y",strtotime($tgl_dibuat));?></small>
		              </p>
		            </li>
		            ...
		            <!-- Menu Footer-->
								<li class="user-footer">
									<div class="pull-left">
										<a href="<?php echo base_url('user/edit/'.$id_user); ?>" class="btn btn-default btn-flat">Profil</a>
									</div>
...
<script src="<?php echo base_url(); ?>assets/dashboard_template/adminLTE/plugins/datepicker/bootstrap-datepicker.js"></script>
