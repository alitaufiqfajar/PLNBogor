      ...
      <div class="box-body">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-4">
            ...
            <input type="text" maxlength="100" class="form-control" name="judul" placeholder="judul" >
        ...
        <div class="form-group" id="form_link">
          ...
          <div class="col-sm-4">
            ...
            <input type="text" maxlength="100" class="form-control" name="link" placeholder="Link" >
